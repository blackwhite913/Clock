...
//          .createShader(Rect.fromCircle(center: center, radius: radius))
    ...
    canvas.drawCircle(center, radius+8, fillBrush);
    canvas.drawCircle(center, radius+8, outlineBrush);

    var hourHandX = centerX +
        radius* 0.45 * cos((dateTime.hour * 30 + dateTime.minute * 0.5) * pi / 180);
    var hourHandY = centerY+
        radius* 0.45* sin((dateTime.hour * 30 + dateTime.minute * 0.5) * pi / 180);
